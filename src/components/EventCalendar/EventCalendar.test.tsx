...
const eventData = [
  {
    ...
    endDate: '2022-05-01',
    location: 'New York',
    startTime: '10:00:00' as Time,
    endTime: '12:00:00' as Time,
    allDay: false,
    recurring: false,
    isPublic: true,
    isRegisterable: true,
  ...
  },
  {
    ...
    startTime: '14:00:00' as Time,
    endTime: '16:00:00' as Time,
    allDay: false,
    recurring: false,
    isPublic: true,
    isRegisterable: true,
  ...
  it('Should handle window resize in day view', async () => {
    const multipleEventData = [
      ...
      },
      {
        ...
        endDate: new Date().toISOString().split('T')[0],
        location: 'Los Angeles',
        startTime: '17:00:00' as Time,
        endTime: '19:00:00' as Time,
        allDay: false,
        recurring: false,
        isPublic: true,
        isRegisterable: true,
